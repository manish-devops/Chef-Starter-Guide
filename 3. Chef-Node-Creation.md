...
```sh
Chef-repo> knife bootstrap windows winrm X.X.X.X --winrm-user domain\password --winrm-password PASSWORD --node-name NODENAME --msi-url "Location_of_Chef-Client.msi"
